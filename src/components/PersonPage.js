  ...
  if(props.ident==3){
    return(
      ...
      <div className='portrait_1'>
        ...
        <div class="info">
          ...
          <h3 className="text-coloring"><FormattedMessage id="IdentYears3">1860-1910 г. </FormattedMessage></h3>
    ...
    return(
      ...
      <div className='portrait_4'>
        ...
        <div class="info" >
          <h2 className="text-coloring"><FormattedMessage id="IdentName1">Алексеев Александр Алексеевич</FormattedMessage></h2>
          <h3 className="text-coloring"><FormattedMessage id="IdentYears1">1978 год.</FormattedMessage></h3>
